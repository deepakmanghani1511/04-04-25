pipeline {
    ...
    environment {
        ...
        RESOURCE_GROUP = 'rg-jenkins-123'
        APP_SERVICE_NAME = 'deep-integrated-dot-net' // must be unique
    }

    stages {
        stage('Checkout Code') {
            steps {
                git branch: 'main', url: 'https://github.com/deepakmanghani1511/04-04-25.git'
            }
        }
